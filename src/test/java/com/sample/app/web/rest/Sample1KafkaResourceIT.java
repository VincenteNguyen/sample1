...
import com.sample.app.Sample1App;
import com.sample.app.service.Sample1KafkaProducer;
import com.sample.app.service.Sample1KafkaConsumer;
...
@SpringBootTest(classes = Sample1App.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class Sample1KafkaResourceIT {
    ...
    @Autowired
    private Sample1KafkaProducer producer;

    @Autowired
    private Sample1KafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        Sample1KafkaResource kafkaResource = new Sample1KafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/sample-1-kafka/publish?message=test"))
